...
export const NotificationWidget = ({
  ...
  return (
    <NotificationWidgetWrapper>
      <div className="notification-card roe-shadow-2">
        <div className="notifiaction-header">{heading}</div>
        ...
        <div className="noification-list">
                ...
                return (
                  <div className="container list-container" key={i}>
                    <div className="row ptb-20">
                      <div className="col-2">
                        <span className="notifiaction-icon">
                      ...
                      <div className="col-3 fs-12 demi-bold-text">{e.time}</div>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="container list-container">
            <div className="ptb-20 text-center show-more">Show More</div>
          </div>
        </div>
      </div>
    </NotificationWidgetWrapper>
